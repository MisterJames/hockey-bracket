<template>
  <g :transform="`translate(${x}, ${y})`">
    ...
    <rect v-if="isWinner" x="0" y="-2" width="80" height="26" fill="#c8f2d3" rx="4" ry="4" />

    <image v-if="team?.logo" :href="team.logo" x="4" y="2" width="16" height="16" :opacity="isEliminated ? 0.5 : 1" />
