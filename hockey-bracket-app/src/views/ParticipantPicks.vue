  ...
  <div class="p-6">
    ...
    <div class="mt-10">
      ...
      <div class="flex space-x-4">
        <button v-for="team in getFinalOptions()" :key="team.id"
          class="w-48 flex items-center justify-between px-3 py-2 border rounded hover:bg-blue-100" :class="{
    ...
    <div class="mt-8">
      <button class="bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 disabled:opacity-50"
        :disabled="!isComplete" @click="savePicks">
        💾 Save All Picks
      </button>
    </div>
  </div>
